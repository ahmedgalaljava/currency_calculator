CREATE DATABASE  IF NOT EXISTS `currency` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `currency`;
...
INSERT INTO `currency_rate` VALUES (1,'usd','egp',NULL,18.4700),(2,'egp','usd',NULL,0.0540),(3,'inr','usd',NULL,0.0130),(4,'usd','inr',NULL,76.1500);
...
-- Dump completed on 2022-04-22  1:11:49
